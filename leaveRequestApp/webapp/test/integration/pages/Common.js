sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("oe/leaveRequestApp/app", ".html");
		...
		return Opa5.extend("oe.leaveRequestApp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["oe/leaveRequestApp/localService/mockserver"], function (mockserver) {
